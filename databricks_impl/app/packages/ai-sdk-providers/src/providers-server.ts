...
export const CONTEXT_HEADER_ASSISTANT_MESSAGE_ID =
  'x-databricks-assistant-message-id';
...
export const databricksFetch: typeof fetch = async (input, init) => {
  ...
  const assistantMessageId = headers.get(CONTEXT_HEADER_ASSISTANT_MESSAGE_ID);
  ...
  headers.delete(CONTEXT_HEADER_ASSISTANT_MESSAGE_ID);
